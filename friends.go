...
type Friends struct {
	...
	FriendsUUID types.NullString `json:"user_id" db:"user_uuid" ops:"create" orm_type:"varchar(40)" orm_default:"not null"`
	FriendUUID  types.NullString `json:"friend_id" db:"friend_uuid" ops:"create" orm_type:"varchar(40)" orm_default:"not null"`
