...
func (sb *subsRepository) Updatex(ctx context.Context, sub infoblog.Subscriber, condition infoblog.Condition, ops string) error {
	return sb.crud.updatex(ctx, &sub, condition, ops)
}
