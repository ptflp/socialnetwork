...
func (c *ChatRepository) Listx(ctx context.Context, condition infoblog.Condition) ([]infoblog.Chat, error) {
	var chats []infoblog.Chat
	err := c.crud.listx(ctx, &chats, infoblog.Chat{}, condition)
	if err != nil {
		return nil, err
	}
